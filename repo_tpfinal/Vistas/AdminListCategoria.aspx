            ...
            <asp:GridView ID="grdCategorias" CssClass="GridViewStyled" runat="server" CellPadding="4" AutoGenerateColumns="False" AllowPaging="True" ForeColor="#333333" GridLines="None" PageSize="5" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True" OnRowCancelingEdit="grdCategorias_RowCancelingEdit" OnRowEditing="grdCategorias_RowEditing" OnRowUpdating="grdCategorias_RowUpdating" OnPageIndexChanging="grdCategorias_PageIndexChanging" >
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="ESTADO">
                        <EditItemTemplate>
                            <asp:TextBox ID="txt_eit_estadoCat" runat="server" Text='<%# Bind("Estado") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
