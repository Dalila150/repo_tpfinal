...
namespace Dao
{
    public class DaoUsuario
    {
        ...
        public DataTable getTablaUsuario()
        {
            ...
            DataTable tabla = ds.ObtenerTabla("Usuario", "SELECT u.ID_usuario,u.Nombre_Usuario,u.Nombre,u.Apellido,r.Tipo_de_Rol FROM usuario u INNER JOIN rol r ON U.Rol = r.ID_rol");
            return tabla;
        }
        ...
        {
            // List<Categoria> lista = new List<Categoria>();
            DataTable tabla = ds.ObtenerTabla("Usuario", "SELECT u.ID_usuario,u.Nombre_Usuario,u.Nombre,u.Apellido,r.Tipo_de_Rol FROM usuario u INNER JOIN rol r ON U.Rol = r.ID_rol where Nombre Like'" + Nombre + "%'");
            return tabla;
        }
        public DataTable getTablaUsuarioEspecificoApellido(string Nombre)
        {
            // List<Categoria> lista = new List<Categoria>();
            DataTable tabla = ds.ObtenerTabla("Usuario", "SELECT u.ID_usuario,u.Nombre_Usuario,u.Nombre,u.Apellido,r.Tipo_de_Rol FROM usuario u INNER JOIN rol r ON U.Rol = r.ID_rol where Apellido Like'" + Nombre + "%'"
);
            return tabla;
        }
